    ...
    return(
        <div className = " w-screen h-screen flex flex-col justify-center items-center bg-stone-100 ">
          <div className = " w-80 h-2.5/5  p-8 shadow-lg shadow-gray-500 flex flex-col bg-white font-['Georgia'] rounded" >
            <h1 className = "flex flex-row justify-center heading font-extrabold text-3xl pb-4"> SignUp </h1>
            ...
            <input className="border-2 rounded p-1 outline-none" type="email"
             ...
             value={formData.password}
             onChange = {handleChange} />
            <button type="submit" className = "bg-indigo-500 text-white font-extrabold rounded font-['Georgia'] py-2">SignUp</button>
            </div>
          </div>
          </div>
    )
